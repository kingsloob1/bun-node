...
|---|---|---|
| [`@kingsleyweb/bun-jobs`](../packages/bun-jobs) | [`bun-jobs/`](./bun-jobs) | 39 examples: queues, workers, the job registry, scheduling, flow control, failures, the runner, every driver, integrations — plus 10 option tours that assert every option works as documented |
