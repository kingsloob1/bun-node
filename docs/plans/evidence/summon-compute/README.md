...
[`../../worker-runtimes.md`](../../worker-runtimes.md). All three files were
gathered on 2026-09-25. None of them builds or runs anything in the repo.
...
Every item the three files leave open is carried, with attribution, into
`summon-compute.md` §12.1 (Q1–Q30).
