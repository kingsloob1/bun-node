...
| **D4** | `WorkerTarget` | Renamed to **`WorkerSelector`** in this rename (Phase 0), so that `WorkerTarget` is free for Phase 1's execution-target option (`target: "worker-thread" \| …`, `docs/plans/worker-runtimes.md:1123-1128`) |
