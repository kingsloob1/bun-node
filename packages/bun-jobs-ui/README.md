...
| Runners list pager | the Runners nav entry's needs, and more runners match the filter than one page holds (25). Its window lives in the URL, as the queue list's does, and changing the filter restarts it |
