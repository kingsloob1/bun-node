...
| Runner history pager | the Runner stats and history's needs, and the runs fetched — the “Runs shown” number — outnumber one page (25). It pages **within what was fetched**, never reading again, and a note under it says as much; a run whose log the URL opens is on the page shown, however far down the history it is |
